...
cputchar(int ch)
{
	...
	// the cputchar founction _always_ outputs to the system console.
	sys_cputs(&c, 1);
}
...
getchar(void)
{
	...
	// Yu-OS does, however, support standard _input_ redirection,
...
devcons_write(struct Fd *fd, const void* vbuf, size_t n)
{
	...
	// mistake: have to nul-terminated arg to sys_cputs,
	// so we have to copy vbuf into buf in chunks and nul-terminated.
